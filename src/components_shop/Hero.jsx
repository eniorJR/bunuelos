          ...
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              ...
              <a href="#products" className="font-semibold text-indigo-600">
                ...
                Pedir ya <span aria-hidden="true">&rarr;</span>
              </a>
            </div>
          </div>
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">
              Buñuelos Artesanales Recién Hechos
            </h1>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
              Desde 1990 elaborando los mejores buñuelos artesanales de España.
              Descubre nuestra selección de sabores tradicionales y modernos,
              disponibles para entrega en toda la península.
            </p>
